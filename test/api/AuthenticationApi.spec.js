...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NationalDigitalIdentityNdiAspApi.AuthenticationApi();
  });
  ...
  describe('AuthenticationApi', function() {
    ...
    describe('initiateQRAuth', function() {
      it('should call initiateQRAuth successfully', function(done) {
        //uncomment below and update the code to test initiateQRAuth
        //instance.initiateQRAuth(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('responses', function() {
      it('should call responses successfully', function(done) {
        //uncomment below and update the code to test responses
        //instance.responses(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('v1AspAuthLoginPost', function() {
      it('should call v1AspAuthLoginPost successfully', function(done) {
        //uncomment below and update the code to test v1AspAuthLoginPost
        //instance.v1AspAuthLoginPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
